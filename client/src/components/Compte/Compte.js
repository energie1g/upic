...
class Compte extends React.Component {
        ...
        if (!redirectToLogin) {
            try {
                ...
                isFollowing = await axios.get(
                    `${SERVER_URL}/${this.props.match.params.id}/${
                        this.state.user_id
                    }`
                );
                ...
                this.mounted &&
                    this.setState({
                        ...
                        followBtnClr:
                            isFollowing.data.abonne === 0 ? 'blue' : 'grey',
    ...
    fileChange = async e => {
        this.setState(
            { pFile: e.target.files, pLoading: true },
            async function() {
                        ...
                        <div className={classes.Compte}>
                            <div className={classes.CompteHead}>
                                <Image
                                    ...
                                    onMouseEnter={
                                        this.profileImageOnMouseEnterHandler
                                    }
                                    onMouseLeave={
                                        this.profileImageOnMouseLeaveHandler
                                    }
                                    style={{
                                        overflow: 'inherit',
                                        height: 150,
                                ...
                                <div>
                                    ...
                                    <div className={classes.UserSubInfo}>
                                        ...
                                        <div>
                                            {this.state.abonnements} following
                                        </div>
                                    </div>
                                </div>
                            </div>
